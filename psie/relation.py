    ...
    def finetuning(self, train_loader, val_loader, device, max_norm, optimizer, weight=None):
        ...
        with torch.no_grad():
            for val_idx, val_batch in enumerate(val_loader):
                ...
                val_predictions = self(input_ids=val_ids, attention_mask=val_mask, tags=val_tags).view(-1, 2)
                batch_val_loss = criterion(val_predictions, val_labels)
        ...
        return epoch_loss, val_loss_avg, train_accuracy, accuracy, f1, recall
